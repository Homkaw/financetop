...
#       [app]
#       title = financetop# This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = financetop
#          package.name =  financetop# This is all part of the title.
#
